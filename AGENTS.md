...
README.md is the canonical user guide for setup, HTTP/MCP use, remote access and recovery. Keep it friendly and organized around reader tasks; do not recreate a separate operator guide or put development chronology in the getting-started flow.
